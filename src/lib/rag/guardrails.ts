...
export const INJECTION_REPLY =
  "Nice try — but I only answer questions about Jeff's background, skills, and projects. Ask me about the fraud detection pipeline, the CLV work, or his RAG systems.";
